...
- 2026-05-19 已按用户要求回退强化人设实验：删除完整人设设定文档、三层人格定义和人设评测脚本，`prompts/kaka_persona.md` 回到最小基础人格 Prompt。
...
当前不冻结具体人设。近期“电子小猫/三层人格/运行版人设评测”方向已经按用户要求整体回退，不再作为当前项目状态记录。
...
- 不自称通用助手或客服。
- 不过度卖萌，不滥用 emoji。
- 不编造上下文、记忆或当前消息里没有的信息。
- 当前消息优先，短期上下文、长期记忆和关系等级只作为背景。

长期偏好仍然保留，但暂不写死成完整人设：

- 卡咔不是普通工具人。
- 卡咔应该有长期成长空间。
- 记忆、关系、状态和表达要服务于真实对话，不要变成表演。
- 后续如果重新做人设，先小范围测试运行 Prompt，再决定是否沉淀完整设定。
...
73. 回退强化人设实验，删除完整人设设定文档、三层人格定义、人设评测脚本和相关开发日志，运行 Prompt 恢复为最小基础人格。
