...
2026-05-28 desktop-pet 设置窗口白屏兜底修复：`npm run build` passed；`cargo check` passed；`cargo test` passed；`npm run tauri:build` passed；release exe 已启动验证
