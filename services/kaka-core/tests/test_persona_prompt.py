...
def test_default_persona_prompt_is_safe_public_fallback(tmp_path) -> None:
    prompt = load_persona_prompt(PersonaSettings(prompt_path=tmp_path / "missing-private-persona.md"))
